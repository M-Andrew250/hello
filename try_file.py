...
# set_page_config
st.set_page_config(page_title="GDP Dashboard", page_icon=":bar_chart:", layout="wide")
...
def dashboard():
    ...
    with cor2:
        ...
        st.metric(label = "GDP growth rate", value = float(filtered_year["GROWTH RATE"]*100))
...
def charts():
    ...
    with cor6:
        ...
        st.metric(label = "Rate", value = float(filtered_cat2["GROWTH RATE"]*100))
